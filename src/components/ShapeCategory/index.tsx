...
const ShapeCategory = () => {
  ...
  return (
   <>
      ...
      <h2 className={`text-[20px] md:text-3xl text-[#43825c] font-bold mb-10 md:mb-16 ${philosopher.className}`}>SHOP BY SHAPE
      <Image
      ...
      <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-6 px-4 md:px-8">
        {shapes.map((shape) => (
           ...
           <div
            key={shape.id}
            className="relative w-[80px] overflow-hidden h-[80px] sm:w-[100px] sm:h-[100px] flex flex-col items-center space-y-2 p-4 bg-white rounded-full
