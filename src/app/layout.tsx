...
export const metadata: Metadata = {
  ...
  description:
    "Discover timeless elegance with Claire Diamonds. Explore engagement rings, necklaces, earrings, and more – designed with love.",
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* ❌ REMOVE <Head> - Not allowed in app router */}
        <title>Claire Diamonds | Lab-Grown Diamond Rings & Minimal Jewelry</title>
        <meta
          name="description"
